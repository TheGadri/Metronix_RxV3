						<div class="kt-subheader-search d-none">
								...
								<form class="kt-form">
									<div class="kt-grid kt-grid--desktop kt-grid--ver-desktop">
										...
										<div class="kt-grid__item kt-grid__item--middle">
											...
											<button type="button"
												class="btn btn-pill btn-upper btn-bold btn-font-sm kt-subheader-search__submit-btn">Search
												Bookings</button>
						...
						<!-- begin:: Content -->
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" id="currentarea">
										...
										<div class="kt-portlet__head">
											...
											<div class="kt-portlet__head-toolbar">
												<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-toggle="tab" href="#kt_widget11_tab1_content"
															role="tab">
															Last Month
														</a>
													</li>
															...
															<table class="table">
																...
																<tbody>
																	<tr>
																		...
																		<td>$63</td>
																		<td><span
																				class="kt-badge kt-badge--inline kt-badge--brand">new</span>
																		</td>
																	...
																	<tr>
																		...
																		<td>$39</td>
																		<td><span
																				class="kt-badge kt-badge--inline kt-badge--success">approved</span>
																		</td>
																	...
																	<tr>
																		...
																		<td>$105</td>
																		<td><span
																				class="kt-badge kt-badge--inline kt-badge--warning">pending</span>
																		</td>
																	...
																	<tr>
																		...
																		<td>11,094</td>
																		<td>$16</td>
																		<td><span class="kt-badge kt-badge--inline kt-badge--danger">on
																				hold</span></td>
															...
															<table class="table">
																...
																<tbody>
																	<tr>
																		...
																		<td>$63</td>
																		<td><span
																				class="kt-badge kt-badge--inline kt-badge--danger">pending</span>
																		</td>
																		<td class="kt-align-right kt-font-brand  kt-font-bold">$23,740
																		</td>
																	</tr>
																	<tr>
																		<td>
																		...
																		<td>$39</td>
																		<td><span
																				class="kt-badge kt-badge--inline kt-badge--success">new</span>
																		</td>
																		<td class="kt-align-right kt-font-success  kt-font-bold">$46,010
																		</td>
																	</tr>
																	<tr>
																		<td>
																		...
																		<td>$105</td>
																		<td><span
																				class="kt-badge kt-badge--inline kt-badge--brand">approved</span>
																		</td>
																		<td class="kt-align-right kt-font-danger kt-font-bold">$15,800
																		</td>
																	</tr>
																	<tr>
																		<td>
																		...
																		<td>$16</td>
																		<td><span
																				class="kt-badge kt-badge--inline kt-badge--info">done</span>
																		</td>
																		<td class="kt-align-right kt-font-warning kt-font-bold">$8,520
																		</td>
																	</tr>
																</tbody>
															</table>
																...
																<svg xmlns="http://www.w3.org/2000/svg"
																	...
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		...
																		<circle id="Oval-5" fill="#000000" opacity="0.3" cx="12" cy="12"
																			r="10" />
																		<rect id="Rectangle-9" fill="#000000" x="11" y="10" width="2"
																			height="7" rx="1" />
																...
																<span data-toggle="kt-tooltip" data-placement="right"
																	...
																	<svg xmlns="http://www.w3.org/2000/svg"
																		...
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																			...
																			<rect id="Rectangle-9" fill="#000000" x="11" y="10" width="2"
																				height="7" rx="1" />
																			<rect id="Rectangle-9-Copy" fill="#000000" x="11" y="7"
													...
													<div class="kt-timeline-v2__item">
														...
														<div class="kt-timeline-v2__item-text kt-padding-top-5">
															Placed a new order in <a href="#"
																class="kt-link kt-link--brand kt-font-bolder">SIGNATURE MOBILE</a>
															marketplace.
														</div>
													</div>
													<div class="kt-timeline-v2__item">
									...
									<div class="kt-portlet kt-portlet--height-fluid">
										<div class="kt-portlet__head">
											...
											<div class="kt-portlet__head-toolbar">
												<ul class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-toggle="tab" href="#kt_widget3_tab1_content"
															role="tab">
															Today
														</a>
													</li>
