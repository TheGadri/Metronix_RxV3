...
<html lang="en">
	...
	<head>
		...
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title>Rx Insurance System | Dashboard</title>
		...
		<!-- CUSTOM CSS -->
		<link href="<?php echo BASE_URL ?>assets/css/demo6/custom.css" rel="stylesheet" type="text/css" />
		<!-- END CUSTOM CSS -->
	</head>
					...
					<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
						<div class="kt-container  kt-container--fluid ">
							<div class="kt-footer__copyright">
								2019&nbsp;&copy;&nbsp;<a href="http://keenthemes.com/metronic" target="_blank" class="kt-link">Rx Health Info Systems</a>
							</div>
							<div class="kt-footer__menu">
								<a href="http://keenthemes.com/metronic" target="_blank" class="kt-footer__menu-link kt-link">Vist Our Site</a>
								<a href="http://keenthemes.com/metronic" target="_blank" class="kt-footer__menu-link kt-link">About Us</a>
								<a href="http://keenthemes.com/metronic" target="_blank" class="kt-footer__menu-link kt-link">Contact Us</a>
							</div>
						</div>
					</div>
