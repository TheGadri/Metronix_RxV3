                    ...
                    <table class="table table-hover">
                        ...
                        <tbody class="kt-datatable__body">
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                ...
                                <td data-field="firstname" class="kt-datatable__cell no_v"><span>Billing</span>
                                </td>
                                <td data-field="date_of_birth" class="kt-datatable__cell no_v">
                                    <a onclick="getstep('permission')" href="javascript:;">Role Permission</a> <span>&nbsp;|&nbsp;</span>
                                    <a onclick="getstep('edit_role')"  href="javascript:;">Edit</a>
                                </td>
                            </tr>
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                <td data-field="surname" class="kt-datatable__cell no_v"><span>2</span>
                                </td>
                                <td data-field="firstname" class="kt-datatable__cell no_v"><span>Champion</span>
                                </td>
                                <td data-field="date_of_birth" class="kt-datatable__cell no_v">
                                    <a onclick="getstep('permission')" href="javascript:;">Role Permission</a> <span>&nbsp;|&nbsp;</span>
                                    <a onclick="getstep('edit_role')"  href="javascript:;">Edit</a>
