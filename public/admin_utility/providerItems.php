                ...
                <table class="table table-hover">
                    <thead class="kt-datatable__head table-warning">
                        <tr class="kt-datatable__row" style="left: 0px;">
                            <th data-field="provider_item_name" class="kt-datatable__cell kt-datatable__cell--sort">
                                <span style="width: 100px;">Provider Item Name</span></th>
                            <th data-field="rxclaim_code" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                    style="width: 100px;">RxClaim Code</span></th>
                            <th data-field="rxclaim_name" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                    style="width: 100px;">Rx Claim Name</span></th>
                            <th data-field="item_category" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                    style="width: 100px;">Item Category</span></th>
                            <th data-field="price" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                    style="width: 100px;">Price</span></th>
                    ...
                    <tbody class="kt-datatable__body">
                        <tr onclick="getstep('update_provider_item')" data-row="0" class="kt-datatable__row"
                            style="left: 0px;">
                            <td data-field="" class="kt-datatable__cell no_v"><span>Handwriting Therapy</span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span>OCT00001</span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span> </span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span>Occupational Therapy</span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span>0.00</span></td>
                        ...
                        <tr onclick="getstep('update_provider_item')" data-row="0" class="kt-datatable__row"
                            style="left: 0px;">
                            <td data-field="" class="kt-datatable__cell no_v"><span>TIBC</span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span>LAB00001</span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span> </span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span>Laboratory</span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span>0.00</span></td>
                            <td data-field="actions" class="kt-datatable__cell no_v"><span>
                                    <a title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md"> <i
                        ...
                        <tr onclick="getstep('update_provider_item')" data-row="0" class="kt-datatable__row"
                            style="left: 0px;">
                            <td data-field="" class="kt-datatable__cell no_v"><span>1-Way Central Venous Catheter-Pediatric</span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span>CNB00001</span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span> </span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span>Consumables</span>
                            </td>
                            <td data-field="" class="kt-datatable__cell no_v"><span>0.00</span></td>
                            <td data-field="actions" class="kt-datatable__cell no_v"><span>
                                    <a title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md"> <i
