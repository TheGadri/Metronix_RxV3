                    ...
                    <table class="table table-hover">
                        <thead class="kt-datatable__head table-warning">
                            <tr class="kt-datatable__row p-5" style="left: 0px;">
                                ...
                                <th data-field="service_provider" class="kt-datatable__cell kt-datatable__cell--sort">
                                    <span>Service Provider Name</span></th>
                        ...
                        <tbody class="kt-datatable__body">
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                <td colspan="2" data-field="surname" class="text-center kt-datatable__cell no_v kt-font-bold">
                                    <span>CLICK TO CHECK ALL PROVIDERS</span>
                                </td>
