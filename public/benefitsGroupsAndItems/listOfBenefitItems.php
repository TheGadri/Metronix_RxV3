        ...
        <div class="table-responsive">
            <table class="table" id="companyBenefitChart">
                <colgroup>
                    ...
                    <col class="table-success" span="5">
                    
                    <col class="table-danger" span="5">
                ...
                <thead class="table-warning">
                    <tr>
                      ...
                      <!--  <th colspan="2">MEMBER ONLY</th> -->
                        <th colspan="5" class="text-center">Member Of 1</th>
                        <th colspan="5" class="text-center">Member Of 2</th>
                        <th colspan="5" class="text-center">Member Of 3</th>
                        <th colspan="5" class="text-center">Member Of 4+</th>
                    ...
                    <tr>
                        ...
                        <td class="table-secondary text-center">
                         <!--   <div class="btn-group" role="group" aria-label="Button group">
                           ...
                           <div class="btn-group" role="group" aria-label="Button group">
                                <button type="button" onclick="getstep('edit_benefit_items')" class="btn btn-sm btn-outline-brand">Edit</button>
