                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 kt-margin-b-20-tablet-and-mobile">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Add new group" id="add_group"
                                    name="add_group">
                                <div class="input-group-append">
                                    <button class="btn btn-success btn-icon btn-icon-md" type="button"><i
                ...
                <table class="table table-hover">
                    <thead class="kt-datatable__head table-warning">
                        <tr class="kt-datatable__row p-5" style="left: 0px;">
                            ...
                            <th data-field="group_name" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                    style="width: 100px;">Group Name</span></th>
                            <th data-field="sub_group" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                    style="width: 100px;">No. of Sub Groups</span></th>
                            <th data-field="action" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                    style="width: 100px;">Action</span></th>
                        </tr>
                    </thead>
                    <tbody class="kt-datatable__body">
                        <tr onclick="getstep('listOfCorporate')" data-row="0" class="kt-datatable__row"
                            style="left: 0px;">
                            <th data-field="id" class="kt-datatable__cell no_v"><span>1</span>
                            </th>
                            <td data-field="group" class="kt-datatable__cell no_v"><span>1534</span>
                            </td>
                            <td data-field="sub_group" class="kt-datatable__cell no_v"><span>Jamz</span>
                            </td>
                        ...
                        <tr onclick="getstep('listOfCorporate')" data-row="1" class="kt-datatable__row"
                            style="left: 0px;">
