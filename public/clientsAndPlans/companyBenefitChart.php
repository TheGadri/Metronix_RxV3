                    ...
                    <tr>
                        ...
                        <td class="table-secondary text-center">
                            <div class="btn-group" role="group" aria-label="Button group">
                                <button onclick="getstep('company_benefitChart_addbenefit')" type="button"
                                    class="btn btn-sm btn-outline-brand">Add Benefit</button>
                                <button data-toggle="dropdown" type="button"
                                    class="btn dropdown-toggle dropdown-toggle-split btn-sm btn-outline-brand">
                                    <span class="sr-only">Toggle Dropdown</span>
                                </button>
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-start"
                                    style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(80px, 38px, 0px);">
                                    <a data-toggle="modal" data-target="#edit_benefit_chart" class="dropdown-item"
                                        href="javascript:;"><i class="flaticon-edit-1"></i>Edit</a>
                                    <a class="dropdown-item" href="javascript:;" data-toggle="modal"
                                        data-target="#attachNewHealthPlan"><i class="flaticon-delete"></i>Delete</a>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" value="Some text goes here" readonly
                                    id="benefit_group_name" name="benefit_group_name">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="benefit_group_code"
