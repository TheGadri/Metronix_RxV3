                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded" id="local_data"
                    ...
                    <table class="table table-hover">
                        <thead class="kt-datatable__head table-warning">
                            <tr class="kt-datatable__row p-5" style="left: 0px;">
                                ...
                                <th data-field="provider_item_name" class="kt-datatable__cell kt-datatable__cell--sort">
                                    <span>Provider Item Name</span></th>
                                <th data-field="rxclaim_code" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                        s>RxClaim Code</span></th>
                                <th data-field="rxclaim_name" class="kt-datatable__cell kt-datatable__cell--sort">
                                    <span>RxClaim Name</span></th>
                                <th data-field="item_catgory" class="kt-datatable__cell kt-datatable__cell--sort">
                                    <span>Item Category</span></th>
                                <th data-field="price" class="kt-datatable__cell kt-datatable__cell--sort">
                                    <span>Price</span>
                                </th>
                        ...
                        <tbody class="kt-datatable__body">
                            <tr onclick="getstep('list_of_item_detail')" data-row="0" class="kt-datatable__row"
                                style="left: 0px;">
                                <td data-field="id" class="kt-datatable__cell no_v"><span>1</span>
                                </td>
                                <td data-field="provider_item_name" class="kt-datatable__cell no_v"><span>Jamz</span>
                                </td>
                                <td data-field="rxclaim_code" class="kt-datatable__cell no_v"><span>ICD-09900JH</span>
                                </td>
                                <td data-field="rxclaim_name" class="kt-datatable__cell no_v"><span>OLoadoer</span></td>
                                <td data-field="item_catgory" class="kt-datatable__cell no_v"><span>Drugs</span></td>
                                <td data-field="price" class="kt-datatable__cell no_v"><span>0.00</span>
                                </td>
                            ...
                            <tr onclick="getstep('list_of_item_detail')" data-row="1" class="kt-datatable__row"
                                style="left: 0px;">
                                <td data-field="id" class="kt-datatable__cell no_v"><span>2</span>
                                </td>
                                <td data-field="provider_item_name" class="kt-datatable__cell no_v"><span>Jamz</span>
                                </td>
                                <td data-field="rxclaim_code" class="kt-datatable__cell no_v"><span>ICD-09930JH</span>
                                </td>
                                <td data-field="rxclaim_name" class="kt-datatable__cell no_v"><span>HULOPM</span></td>
                                <td data-field="item_catgory" class="kt-datatable__cell no_v"><span>Drugs</span></td>
                                <td data-field="price" class="kt-datatable__cell no_v"><span>5.00</span>
                                </td>
                                <td data-field="actions" class="kt-datatable__cell no_v"><span>
                                        <a title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md"> <i
                                                class="la la-exclamation-circle"></i> </a>
