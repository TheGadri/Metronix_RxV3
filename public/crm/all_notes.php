                ...
                <table class="table table-hover">
                    <thead class="kt-datatable__head table-warning">
                        <tr class="kt-datatable__row p-5" style="left: 0px;">
                            ...
                            <th data-field="createdBy" class="kt-datatable__cell kt-datatable__cell--sort"><span>Created
                                    By</span></th>
                    ...
                    <tbody class="kt-datatable__body">
                        ...
                        <tr data-toggle="modal" data-target="#note_details" data-row="1" class="kt-datatable__row"
                            style="left: 0px;">
                            <td data-field="id" class="kt-datatable__cell no_v"><span>1</span>
                            </td>
                            <td data-field="datetime" class="kt-datatable__cell no_v"><span>31/12/2000</span>
...
<!-- Modals -->
<!-- Note Details -->
<div class="modal fade" id="note_details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
