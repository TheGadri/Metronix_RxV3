                    ...
                    <thead class="kt-datatable__head table-warning">
                        <tr class="kt-datatable__row p-5" style="left: 0px;">
                            ...
                            <th data-field="datetime" class="kt-datatable__cell kt-datatable__cell--sort"><span>Date
                                    Time</span></th>
                            <th data-field="activity_type" class="kt-datatable__cell kt-datatable__cell--sort">
                                <span>Activity Type</span></th>
                            <th data-field="outcome" class="kt-datatable__cell kt-datatable__cell--sort">
                                <span>Outcome</span></th>
                            <th data-field="description" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                    style="width:">Description</span></th>
                            <th data-field="created_by" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                    style="width:">Created By</span></th>
                            <th data-field="action" class="kt-datatable__cell kt-datatable__cell--sort"><span
                                    style="width:">Action</span></th>
                        </tr>
                    </thead>
                    <tbody class="kt-datatable__body">
                        <tr data-toggle="modal" data-target="#log_details" data-row="0" class="kt-datatable__row"
                            style="left: 0px;">
                            ...
                            <td data-field="activit_type" class="kt-datatable__cell no_v"><span>Out-Going Call</span>
                            </td>
                            <td data-field="outcome" class="kt-datatable__cell no_v"><span>No answer</span>
                            </td>
                            <td data-field="description" class="kt-datatable__cell no_v"><span>Lorem ipsum dolor sit
                                    amet consectetur adipisicing elit. Iste possimus ex qui natus minu</span>
                            </td>
                            <td data-field="createdBy" class="kt-datatable__cell no_v"><span>Jame Gerdener</span></td>
...
<!-- Modals -->
<!-- Note Details -->
<div class="modal fade" id="log_details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Log Actvity Details</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <label for="" class="col-md-2 col-form-label kt-font-bold">Activity Type</label>
                    <label for="" class="col-md-8 col-form-label">12th Jul,19 10:53am</label>
                </div>
                <div class="row">
                    <label for="" class="col-md-2 col-form-label kt-font-bold">Outcome</label>
                    <label for="" class="col-md-8 col-form-label">12th Jul,19 10:53am</label>
                </div>
                <div class="row">
